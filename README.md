...
yarn
```
2. Configure your apiKey,apiRegion,userId,displayName in /example/src/App.tsx file(https://github.com/AmityCo/Amity-Social-UIKit-React-Native-CLI-OpenSource/blob/main/example/src/App.tsx) first before run the sample app
...
```sh
1. git clone git@github.com:AmityCo/Amity-Social-Cloud-UIKit-React-Native-CLI-OpenSource.git
...
```sh
1. yarn add ./asc-react-native-ui-kit/amityco-asc-react-native-ui-kit-x.x.x.tgz
